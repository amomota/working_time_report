    ...
    <div class="row panel">
        <div class="col-md-8 col-md-offset-2">
            @if(Auth::User()->isadmin)
                ...
                @endforeach
                <form class="form-horizontal" method="post" action={{url('/nokia_expense/nokia_expensesstore/'.$user->id)}}>
            @else
                <h3>Nokia経費を入力してください：</h3>
                <form class="form-horizontal" method="post" action={{url('/nokia_expense/nokia_expensesstore')}}>
            @endif
                <fieldset>
