...
<div class="container">
    <div class="row panel">
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" method="post" action={{url('/user/userprofile/save/'.$users->id)}}>
                <legend>プロフィールを修正する:</legend>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 input-group ">
                            <input id="name" name="name" type="text" class="form-control input-md" placeholder="例)菊池 修吏" value="{{$users->name}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 input-group ">
                            <input id="aiueo_rder" name="aiueo_rder" type="text" class="form-control input-md" placeholder="例)きくちしゅうじ" value="{{$users->aiueo_rder}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 input-group ">
                            <input id="username" name="username" type="text" class="form-control input-md" placeholder="入力されていません" value="{{$users->username}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 input-group ">
                            <input id="email" name="email" type="text" class="form-control input-md" placeholder="指定されたEmailを入力" value="{{$users->email}}">
                        </div>
                    </div>
                   ...
                   <!-- Text input-->
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-5 control-label" for="nokia_in">入場日</label>
                        <div class="col-md-4 input-group date" data-provide="datepicker">
                            <input id="nokia_in" name="nokia_in" type="text" class="form-control input-md" placeholder="" value="{{$users->nokia_in}}">
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-5 control-label" for="nokia_out">退場日</label>
                        <div class="col-md-4 input-group date" data-provide="datepicker">
                            <input id="nokia_out" name="nokia_out" type="text" class="form-control input-md" placeholder="" value="{{$users->nokia_out}}">
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-th"></span>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="submit"id="regbtn" name="save" class="btn btn-success" value="保存する">
