...
<div class="container">
    <div class="row panel">
        <div class="col-md-8 col-md-offset-2">
		    ...
		    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="day_list">作業日を選択</label>
                        <div class="col-md-6 input-group date" data-provide="date">
                                        <input id = "day_list" name="day_list" type="text" placeholder="作業日を選択" class="form-control input-md" required="">
